...
export const authApi = {
  ...
  sendEmailVerification: () => api.post(API_ENDPOINTS.auth.sendEmailVerification),
  verifyEmail: (payload) => api.post(API_ENDPOINTS.auth.verifyEmail, payload),
  resendEmailVerification: () => api.post(API_ENDPOINTS.auth.resendEmailVerification),
